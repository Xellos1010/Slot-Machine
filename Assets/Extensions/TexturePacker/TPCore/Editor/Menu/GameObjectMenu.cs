...
public class GameObjectMenu : EditorWindow {
	...
	[MenuItem("GameObject/Create Other/Texture Packer/CreateMesh")]
	public static void CreateMesh()  {
		Mesh m = MeshUtil.createBox(Vector2.one, new Vector2(0.5f, 0.5f), new Rect(0, 0, 1, 1));
		m.name = "TPPlane";


	

		AssetDatabase.CreateAsset(m, "Assets/TPPlane.asset");
